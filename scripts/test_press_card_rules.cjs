...
add('admin issuance', 'create', card, 'ALLOW');
...
add('revocation allowed', 'update', { ...card, status: 'REVOKED' }, 'ALLOW');
add('renewal allowed', 'update', { ...card, expiresAt: '2029-12-31T18:30:00Z' }, 'ALLOW');
...
add('registry reservation allowed', 'create', registry, 'ALLOW', { registry: true });
