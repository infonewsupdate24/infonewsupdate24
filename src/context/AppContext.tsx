...
export const DEFAULT_SITE_SETTINGS: SiteGlobalSettings = {
  ...
  siteUrl: 'https://infonewsupdate24.com',
  siteEmail: 'editor@infonewsupdate24.com',
  sitePhone: '+91 9876543210',
  siteAddress: 'गडचिरोली मुख्य ब्युरो कार्यालय, महाराष्ट्र ४४२६०५',
  headerLogoUrl: '',
  footerLogoUrl: '',
  faviconUrl: '',
  rniRegNumber: 'MAHMAR/2026/89452',
  grievanceOfficerName: 'ॲड. सचिन मोरे (कायदेशीर सल्लागार)',
  grievanceOfficerEmail: 'grievance@infonewsupdate24.com',
  grievanceOfficerPhone: '+91 9876543210',
